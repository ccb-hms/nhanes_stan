...
echo "setHook('rstudio.sessionInit', function(newSession) {" >> /usr/local/lib/R/etc/Rprofile.site
echo "  if (newSession) {" >> /usr/local/lib/R/etc/Rprofile.site
echo "    rstudioapi::documentOpen('/install_stan/demo.R')" >> /usr/local/lib/R/etc/Rprofile.site
echo "  }" >> /usr/local/lib/R/etc/Rprofile.site
echo "}, action = 'append')" >> /usr/local/lib/R/etc/Rprofile.site
